    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <motion.div
          ...
          className="relative bg-white/30 border border-white/40 backdrop-blur-xl rounded-3xl p-10 text-left shadow-lg hover:shadow-amber-200/50 transition-all duration-300 overflow-hidden"
        >
          {/* Glow layer */}
          <div className="absolute inset-0 bg-gradient-to-br from-amber-400/10 to-transparent opacity-0 hover:opacity-100 transition-all duration-500"></div>
          ...
          >
            Cleaning is done <span className="text-amber-600 font-semibold">twice a week</span> (8 times
            per month), ensuring your home stays spotless all month long.
          </motion.p>
        </motion.div>
      </div>
    </section>
